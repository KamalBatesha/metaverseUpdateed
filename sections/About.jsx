    ...
    <section className=" paddings relative z-10">
      ...
      >
        ...
        <motion.p
          ...
          className=" text-center sm:text-[32px] text-[20px] mt-[8px] font-normal text-secondary-white text-fit"
        >
        ...
        <motion.img
          ...
          src="arrow-down.svg"
          alt="arrow down"
          className="w-[28px] h-[28px] mt-[28px] object-contain cursor-pointer"
        />
      </motion.div>
    </section>
  );
